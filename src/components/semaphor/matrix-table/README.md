...
This is the starter's canonical Semaphor matrix component. Multi-level row
axes render as an expandable hierarchy with one compact indented sticky
row-header column, while pivot columns keep their own expandable column
hierarchy.
...
The `/samples` matrix preview exercises the hierarchy-first matrix shape agents
should use before building a generated Data App page.
